...
export type TestProtocolKey = 'finger_mvc_20mm' | 'finger_endurance_60mvc' | 'repeaters_7_3' | 'pullup_1rm' | 'pullup_endurance_60' | 'pushup_max' | 'side_plank' | 'peak_force' | 'rfd' | 'endurance' | 'repeaters' | 'critical_force' | 'workout' | 'custom_session' | 'free_measurement'
