  ...
  async stop():
    ...
    if (this.running) {
      try {
        ...
        /*
         * The raw acquisition is still valuable.
         * A failure while stopping must not discard
         * the collected curve, but it must prevent
         * the attempt from looking pristine.
         */
        this.warnings.push(
          'stop-error',
        )
